...
const LevelWiseIncome = ({ params }) => {
    const { lvl } = React.use(params);
  ...
  const bind = async () => {
    ...
    const ledger = await historyContract.GetLevelBonus(selectedAccount,lvl);
      ...
      <div className="container">
        <div className="card mt-3">
          <div className="card-header bg-primary text-white">
            <h2 className="card-title">Level {lvl} Income History</h2>
          </div>
...
export default LevelWiseIncome;
